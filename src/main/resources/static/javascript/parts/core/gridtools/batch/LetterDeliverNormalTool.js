 ...
 * @author 陶开杰
 */
Ext.define('OA.parts.core.gridtools.batch.LetterDeliverNormalTool', {
    extend: 'Ext.button.Button',
    alias: 'widget.letterdelivernormaltool',
    text: '(信件)正常',
    scale: 'small',
    ...
    handler: function (button, event) {
        ...
        Ext.Msg.confirm('提示框', '您确定将这些信件的投递状态标记为：正常？', function (btn) {
            if (btn == 'yes') {
                BaseUtil.request({
