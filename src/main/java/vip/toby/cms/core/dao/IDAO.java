...
public interface IDAO {
    ...
    List<Map> list(@SQLParam("tableName") String tableName, @SQLParam("columns") String columns, @SQLParam("condition") String condition, @SQLParam("start") int start, @SQLParam("offset") int offset);
    ...
    @RowHandler(rowMapper = CommonRowMapper.class)
    List<Map> list(@SQLParam("tableName") String tableName, @SQLParam("columns") String columns, @SQLParam("condition") String condition);
    ...
    @RowHandler(rowMapper = CommonRowMapper.class)
    List<Map> getEntity(@SQLParam("tableName") String tableName, @SQLParam("columns") String columns, @SQLParam("idProperty") String idProperty, @SQLParam("id") Object id);
    ...
    List<Map> query(@SQLParam("querySql") String querySql);
