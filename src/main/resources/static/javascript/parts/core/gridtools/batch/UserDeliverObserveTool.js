 ...
 * @author 陶开杰
 */
Ext.define('OA.parts.core.gridtools.batch.UserDeliverObserveTool', {
    extend: 'Ext.button.Button',
    alias: 'widget.userdeliverobservetool',
    text: '(用户)待审核',
    scale: 'small',
    ...
    handler: function (button, event) {
        ...
        Ext.Msg.confirm('提示框', '您确定将这些用户的投递状态标记为：待审核？', function (btn) {
            if (btn == 'yes') {
                BaseUtil.request({
